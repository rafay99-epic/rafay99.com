...
pubDate: 2023-06-30T19:00:00.000Z
draft: false
archived: false
heroImage: https://utfs.io/f/TViMykBJnLIJISeHPxvkaiSjy4bUrO0hVeJp2ALZGDX3nCIl
...
keywords:
  ...
  - technology
canonicalUrl: /blog/optimize-your-fedora-5-essential-post-installation-steps
featured: false
excerpt: Top 5 things when freshed installed Fedora
...
1. Add the following lines of code to the conf file:
...
1. Press Ctrl+X on your keyboard to exit and press Enter to exit the editor.
2. Update your system once more:
...
1. Reboot or restart your system for the changes to take effect.

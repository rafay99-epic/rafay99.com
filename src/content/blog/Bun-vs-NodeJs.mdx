...
pubDate: 2023-09-20T19:00:00.000Z
draft: false
archived: true
heroImage: https://utfs.io/f/TViMykBJnLIJO5n2Alu8kbVhcyQEigAvaB3fqpPwWD0CRnm8
...
keywords:
  ...
  - speed
canonicalUrl: /blog/cooking-up-a-storm-bun-vs-nodejs-performance-showdown
featured: true
excerpt: "Node.js vs. Bun: Which One Prevails?"
---
...
| bun add "package_name"       | npm install "add Package name"   | Add a new package to the project                |
| bun add "package_name" --dev | npm install "package_name" --dev | Add a new development-only package              |
| bun remove "package_name"    | npm uninstall "package_name"     | Remove a package from the project               |
| bun update "package_name"    | npm update "package_name"        | Update a specific package to its latest version |

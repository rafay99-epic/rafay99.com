...
pubDate: 2023-03-11T19:00:00.000Z
draft: false
archived: true
heroImage: https://utfs.io/f/TViMykBJnLIJsBi6BsVuaXy980xWDv1YnVfghNKtcoeEkFsd
...
keywords:
  ...
  - technology
canonicalUrl: /blog/nivida-driver-arch-linux
featured: false
excerpt: Nvidia Drivers on Arch Linux
---
...
1. Check which session you are running—is it Xorg or Wayland? Enter this command to checkout.
...
1. Check which graphics card you are running on your system, and to check, enter the following command into your terminal:

```perl
lspci -k | grep-A 2 -E "(VGA | 3D)"
```

![Image showing my driver](/my-driver.webp)

For me, I have two GPUs: an AMD integrated one and an Nvidia RTX 3060 Mobile.

1. Now that you know the model of your GPU, it's time to go search for a driver using this [link](https://nouveau.freedesktop.org/CodeNames.html). Here you will find the model number of your GPU.
...
1. If your kernel is new and your GPU is supported, then all the drivers can be installed using these commands.
...
1. Paru is an AUR helper, and if you don't have it installed, then install it using these commands.
